"""
Django settings for vitti360 project.
...
SECRET_KEY = 'django-insecure-fd4lwc+sqbm3o&*-fgm(eblbn&y2ale2gg#(=c34swx5ez9=4@'
...
WSGI_APPLICATION = 'vitti360.wsgi.application'
...
SIMPLE_JWT = {
    ...
    # Optional: Enable token rotation and blacklisting
